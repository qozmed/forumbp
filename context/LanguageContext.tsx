...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'settings.customTitle': 'Личный статус',
    'settings.customTitlePlaceholder': 'Введите ваш статус...',
    ...
    'editor.supported': 'Поддерживается: Списки, Размер текста, Картинки, Форматирование',
    'editor.listUnordered': 'Маркированный список',
    'editor.listOrdered': 'Нумерованный список',
    'editor.hr': 'Горизонтальная линия',
    'editor.size': 'Размер текста',
  ...
  en: {
    ...
    'settings.customTitle': 'Custom Title',
    'settings.customTitlePlaceholder': 'Enter custom title...',
    ...
    'editor.supported': 'Supported: Lists, Size, Images, Formatting',
    'editor.listUnordered': 'Unordered List',
    'editor.listOrdered': 'Ordered List',
